...
# Podtřída pro obdélník
class Rectangle(Shape):
    def __init__(self, width, height):
        super().__init__("Rectangle")  # Zavolání konstruktoru základní třídy a nastavení názvu tvaru
        self.width = width
        self.height = height
...
class Circle(Shape):
    def __init__(self, radius):
        super().__init__("Circle")  # Zavolání konstruktoru základní třídy a nastavení názvu tvaru
        self.radius = radius
